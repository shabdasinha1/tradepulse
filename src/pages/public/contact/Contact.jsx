  ...
  <div className="tp-container">
    ...
    <div className="tp-contact-hero-layout">
      ...
      <p className="tp-contact-hero-lead">
        Whether you’re exploring trade intelligence, early access,
        or strategic collaboration we’re here to understand
        your needs and challenges.
      </p>

      {/* Support */}
      <p className="tp-contact-hero-support">
        We focus on insight, clarity, and risk awareness not transactions or marketplaces.
      </p>
  ...
  <div className="tp-container">
    ...
    <div className="tp-contact-paths-grid">
      ...
      <div className="tp-contact-path">
        ...
        <p>
          Learn how TradePulse AI works, explore early access,
          or discuss how intelligence fits into your trade workflow.
        </p>
      ...
      <div className="tp-contact-path">
        ...
        <p>
          Questions about TradePulse AI, the platform vision,
          or how we approach trade intelligence.
        </p>
        <button className="tp-btn-outline">
          Contact Us
        </button>
    ...
    <div className="tp-contact-form-layout">
      ...
      <div className="tp-contact-form-header">
        ...
        <p className="tp-contact-form-sub">
          Share a bit of context and we’ll respond with the
          right information or next steps.
        </p>
      </div>

      {/* Form */}
      <form className="tp-contact-form-card">
  ...
  <div className="tp-container">
    ...
    <div className="tp-contact-cta-layout">
      ...
      <p className="tp-contact-cta-sub">
        ...
        If TradePulse AI is relevant to your use case,
        we’ll follow up with clarity and next steps not automated emails.
      </p>
